...
public class Main {
    public static void main(String[] args) throws DuplicateEntityException, IOException, DataOverlaps, ClassNotFoundException {
        ...
        {
            repository1=new MasinaRepository(setari.getRepoFile());
        ...
        console.runMenu();*/
        ((MasinaRepository) repository1).closeConnection();
