...
public class MasinaRepository extends MemoryRepository<Masina> implements IDbRepository<Masina> {
    ...
    public MasinaRepository(String dbLocation) throws DuplicateEntityException {
